...
@section('content')
    <form method="POST" action="https://Carmanagement.com/logout" accept-charset="UTF-8" style="display:none;"
          id="logout"><input name="_token" type="hidden" value="GAxkUE06uLuWdEZmdioXqaXkQYAgmzY8rG06suzi">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form method="POST" action="https://Carmanagement.com/admin/checks" accept-charset="UTF-8"><input
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control date hasDatepicker" placeholder="" name="check_date"
                                    ...
                                    <div class="form-group col-md-6">
                                        <input class="form-control date2 hasDatepicker" placeholder="วันนัดรับป้ายภาษี"
                                ...
                                <input type="hidden" id="create_by" name="create_by" value="vit_nakon@hotmail.com">
                        ...
                        <input class="btn btn-danger save-bt" onclick="return confirmData()" type="submit" value="Save">
                    </form>
