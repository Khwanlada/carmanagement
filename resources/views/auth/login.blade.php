...
@section('content')
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div style="text-align: center"> <i style="text-align: center" class="fa fa-car fa-5x" aria-hidden="true"></i></div>
            <div style="text-align: center" class="panel panel-default body_bbg">
                <div class="panel-heading">
                    โปรแกรมบริหาร ตรอ. CarManagement
                </div>
